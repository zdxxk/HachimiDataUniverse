 ...
 **铭威图传的默认通道为64**
- 下载并运行  [install_gs.sh](https://raw.githubusercontent.com/svpcom/wfb-ng/refs/heads/master/scripts/install_gs.sh):
	```bash
...
-   完成! 在地面站终端输入如下指令以检测链路:

	```bash
	wfb-cli gs
	```
	 **若RX：gs video数据跳动，表明接收到图传数据**
